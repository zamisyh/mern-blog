                ...
                <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td className="flex px-6 py-4">
                        <button className="btn btn-error btn-sm" onClick={() => onDelete(article._id)}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="text-white" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                        ...
                        <button className="ml-2 btn btn-primary btn-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" className="text-white" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
